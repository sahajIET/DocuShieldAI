  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 font-sans">
      ...
      <div className="w-full mb-4 flex justify-center">
        <div className={`p-3 rounded-lg text-sm font-medium text-center max-w-md ${
      ...
      <div className={`flex flex-col lg:flex-row gap-8 transition-all duration-700 ease-in-out ${
        selectedFile ? 'justify-start items-start' : 'justify-center items-center min-h-[70vh]'
      }`}>
        
        {/* DocuShield AI Section */}
